...
By default, this script will fetch the latest streamflow forecasts for the 
gauge stations on Newfoundland whose observations are assimilated in NSRPS:
...
def fcst_times_from_wms(
    ...
    latest_fcast= wms[layer_name].dimensions['reference_time']['values'][-1]
